...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  ...
  // kernel control, then the privileged-launch toggle, then the kernel version.
  {
    ...
    items: [
      ...
      { key: `${SETTINGS_MENU_KEY.desktop}.kernelManager`, label: 'kernelManager' },
      { key: `${SETTINGS_MENU_KEY.desktop}.tunMode`, label: 'tunMode' },
      { key: `${SETTINGS_MENU_KEY.desktop}.hotkeys`, label: 'globalHotkeys' },
