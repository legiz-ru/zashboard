...
const zh: LANG_MESSAGE = {
  ...
  profiles: '配置',
  importProfile: '导入配置',
  subscriptionUrlPlaceholder: '订阅链接',
  import: '导入',
  noProfiles: '还没有配置。导入一个订阅即可开始。',
  localProfile: '本地文件',
  updatedAt: '更新于',
  use: '启用',
  active: '使用中',
  ...
  minutes: '分钟（0 为关闭）',
  confirmDeleteProfile: '删除配置「{name}」？',
  enable: '开启',
  onboardingWelcomeTitle: '欢迎使用 zashboard',
  onboardingWelcomeBody: '粘贴订阅链接，一分钟内即可用上代理。',
  onboardingGetStarted: '开始',
  onboardingSkip: '跳过',
  onboardingImportTitle: '导入订阅',
  onboardingImportSubtitle: '粘贴服务商提供的订阅链接。',
  onboardingSystemProxyTitle: '开启系统代理',
  onboardingSystemProxyBody: '让本机所有应用的流量都经由代理转发。',
  onboardingDoneTitle: '全部就绪',
  onboardingDoneBody: '订阅已启用。选择一个节点即可开始使用。',
