const en = {
  ...
  // Desktop profiles + first-run wizard
  profiles: 'Profiles',
  importProfile: 'Import a profile',
  subscriptionUrlPlaceholder: 'Subscription URL',
  import: 'Import',
  noProfiles: 'No profiles yet. Import a subscription to get started.',
  localProfile: 'Local file',
  updatedAt: 'Updated',
  use: 'Use',
  active: 'Active',
  autoUpdateInterval: 'Auto-update every',
  minutes: 'min (0 = off)',
  confirmDeleteProfile: 'Delete profile "{name}"?',
  enable: 'Enable',
  onboardingWelcomeTitle: 'Welcome to zashboard',
  onboardingWelcomeBody: 'Paste a subscription and get a working proxy in under a minute.',
  onboardingGetStarted: 'Get started',
  onboardingSkip: 'Skip',
  onboardingImportTitle: 'Import a subscription',
  onboardingImportSubtitle: 'Paste the subscription URL your provider gave you.',
  onboardingSystemProxyTitle: 'Turn on the system proxy',
  onboardingSystemProxyBody: 'Route traffic from every app on this device through the proxy.',
  onboardingDoneTitle: 'All set',
  onboardingDoneBody: 'The subscription is active. Pick a node to get going.',
