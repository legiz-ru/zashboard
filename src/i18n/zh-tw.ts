...
const zhTW: LANG_MESSAGE = {
  ...
  profiles: '設定檔',
  importProfile: '匯入設定檔',
  subscriptionUrlPlaceholder: '訂閱連結',
  import: '匯入',
  noProfiles: '尚無設定檔。匯入訂閱即可開始。',
  localProfile: '本機檔案',
  updatedAt: '更新於',
  use: '啟用',
  active: '使用中',
  ...
  minutes: '分鐘（0 為關閉）',
  confirmDeleteProfile: '刪除設定檔「{name}」？',
  enable: '開啟',
  onboardingWelcomeTitle: '歡迎使用 zashboard',
  onboardingWelcomeBody: '貼上訂閱連結，一分鐘內即可用上代理。',
  onboardingGetStarted: '開始',
  onboardingSkip: '略過',
  onboardingImportTitle: '匯入訂閱',
  onboardingImportSubtitle: '貼上服務商提供的訂閱連結。',
  onboardingSystemProxyTitle: '開啟系統代理',
  onboardingSystemProxyBody: '讓本機所有應用程式的流量都經由代理轉送。',
  onboardingDoneTitle: '全部就緒',
  onboardingDoneBody: '訂閱已啟用。選擇一個節點即可開始使用。',
