...
const ru: LANG_MESSAGE = {
  ...
  // Профили десктопной сборки + мастер первого запуска
  profiles: 'Профили',
  importProfile: 'Импорт профиля',
  subscriptionUrlPlaceholder: 'URL подписки',
  import: 'Импортировать',
  noProfiles: 'Профилей пока нет. Импортируйте подписку, чтобы начать.',
  localProfile: 'Локальный файл',
  updatedAt: 'Обновлён',
  use: 'Выбрать',
  active: 'Активен',
  autoUpdateInterval: 'Автообновление раз в',
  minutes: 'мин (0 — выкл.)',
  confirmDeleteProfile: 'Удалить профиль «{name}»?',
  enable: 'Включить',
  onboardingWelcomeTitle: 'Добро пожаловать в zashboard',
  onboardingWelcomeBody: 'Вставьте подписку и получите рабочий прокси меньше чем за минуту.',
  onboardingGetStarted: 'Начать',
  onboardingSkip: 'Пропустить',
  onboardingImportTitle: 'Импорт подписки',
  onboardingImportSubtitle: 'Вставьте URL подписки, который выдал ваш провайдер.',
  onboardingSystemProxyTitle: 'Включить системный прокси',
  onboardingSystemProxyBody: 'Направлять трафик всех приложений на этом устройстве через прокси.',
  onboardingDoneTitle: 'Всё готово',
  onboardingDoneBody: 'Подписка активна. Выберите узел, чтобы начать работу.',
